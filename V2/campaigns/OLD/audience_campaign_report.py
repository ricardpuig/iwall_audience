  ...
  for row_0 in records_0:  #for each display unit
      ...
      for day_index, day in enumerate(campaign_days):
          ...
          #try: 
            ...
            #ajuste domingos red de universidades de peru 
            fecha_actual= datetime.datetime.strptime(day_formatted, '%Y-%m-%d')
            if mall_id == 117 or mall_id==116 or mall_id==115 or mall_id==114 or mall_id==112 or mall_id==120 : 
              if fecha_actual.weekday() == 6:
                print("Mall is a university - sunday impacts set to 0")
                du_day_campaign_impressions= 0
              if fecha_actual.weekday() == 5:
                print("Mall is a university - saturday impacts lowered")
                du_day_campaign_impressions= du_day_campaign_impressions/2
