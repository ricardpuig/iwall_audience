...
sql= "SELECT id, name, broadsign_container_id from malls "
...
for path, subdirs, files in os.walk(directory):
  for name in files:
      ...
      if "visits" in name: 
        ...
        df_out['hivestack_site_id']=df_out['broadsign_container_id']
        df_out=df_out.drop(['id','name', 'broadsign_container_id'], axis=1)
        df_out.to_csv("./hivestack/"+name, index=False, sep= ",")
