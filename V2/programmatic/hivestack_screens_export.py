...
for country in countries:
    ...
    df_players['Site ID']=df_players['display_unit_container_id']
    df_players['Network']='iwallinshop'
    df_players['Venue type']="Retail – Mall"
    df_players['Floor CPM']=5
    df_players['Languages']="All / Universal"
    df_players['Tags']=""
    df_players['ad_resolution']=df_players['ad_resolution'].str.lower()
    df_players[['Screen width (px)', 'Screen height (px)']]=df_players['ad_resolution'].str.split("x", expand=True)
    ...
    df_players['Minimum ad duration']="5"
    ...
    df_players['Strict IAB category blocking']="No"
    df_players['Strict IAB frequency capping']="No"
    df_players['IAB category frequency cap']=""
    df_players['Latitude']=df_players['latitude']
    df_players['Longitude']= df_players['longitude']
    df_players['Time zone']= timezone
    df_players['Operating hours']="Mon-Sun 10-22"
