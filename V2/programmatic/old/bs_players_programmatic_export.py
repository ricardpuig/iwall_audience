# Get Current player status and information from Broadsign and ingest to table in DB 
...
SPAIN_PLAYER_CONTAINER_ID ="21393898"
COLOMBIA_PLAYER_CONTAINER_ID = '135518539'
PERU_PLAYER_CONTAINER_ID = '53704276'
...
if country=="SPAIN":
        container_ids=[SPAIN_PLAYER_CONTAINER_ID]   #SPAIN PLAYER CONTAINER ID
elif country=="COLOMBIA":
        container_ids=[COLOMBIA_PLAYER_CONTAINER_ID]  #COLOMBIA PLAYER CONTAINER ID
elif country=="PERU":
        container_ids=[PERU_PLAYER_CONTAINER_ID]	#PERU PLAYER CONTAINER ID
else:
	print("Country Missing, exiting....")
	exit(1)
