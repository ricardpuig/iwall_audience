...
if option == 'all':
  ...
  if option == 'id':
    ...
    if sys.argv[4]:
      ...
      target_impressions = 0
    print("analyzing campaign by id")

  else:
    if option == 'name':
        campaign_name=sys.argv[3]
        all_campaigns=False
        print("analyzing campaign by name")
    else:
      if option == 'reset_mall_model':
        all_campaigns=False
        ...
        print("Finished resetting mall audience data")
        exit()
        input()

      else:
        if option == 'list_malls':
          list_malls(mycursor, country)
          exit()
          input()
        else:
          if option == "mall_check":
            ...
            if option == "find_campaign":
              ...
              if option == "finished":
                ...
                if option == "help":
                  ...
                  print("**********")
                  print("")
                  print("bs-campaigns-report.py <option> <country> <value>")
                  print("\nOptions available:")
                  print("------------------")
                  print("all : analyze all campaigns in country. Value is not used")
                  print("id : analyze campaign by id . Value should be the campaign id")
                  print("name : campaign report by name. value should be name of the campaign")
                  print("reset_mall_maodel")
                  print("list_malls")
                  print("find_campaign")
                  exit()
                else: 
...
print("campaigns to analyze type: ", option)
